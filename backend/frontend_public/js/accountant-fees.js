...
class AccountantFees {
    ...
    initialize() {
        ...
        this.tryDeleteFee = async (feeId, token) => {
            ...
            try {
                const deleteUrl = `https://school-93dy.onrender.com/api/fees/${feeId}`;
    ...
    async loadFeesWithFilters() {
        ...
        try {
            ...
            const apiUrl = `https://school-93dy.onrender.com/api/fees?${params.toString()}`;
    ...
    async recordPayment(feeId) {
        try {
            ...
            try {
                ...
                const response = await fetch(`https://school-93dy.onrender.com/api/fees/${feeId}/payments`, {
                    method: 'POST',
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json',
    ...
    async getFeeById(feeId) {
        try {
            ...
            const response = await fetch(`https://school-93dy.onrender.com/api/fees/${feeId}`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
